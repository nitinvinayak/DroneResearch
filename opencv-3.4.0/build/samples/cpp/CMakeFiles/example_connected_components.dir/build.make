...
samples/cpp/CMakeFiles/example_connected_components.dir/connected_components.cpp.o: ../samples/cpp/connected_components.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/pi/opencv-3.4.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object samples/cpp/CMakeFiles/example_connected_components.dir/connected_components.cpp.o"
	cd /home/pi/opencv-3.4.0/build/samples/cpp && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_connected_components.dir/connected_components.cpp.o -c /home/pi/opencv-3.4.0/samples/cpp/connected_components.cpp
...
samples/cpp/CMakeFiles/example_connected_components.dir/connected_components.cpp.i: cmake_force
	...
	cd /home/pi/opencv-3.4.0/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/pi/opencv-3.4.0/samples/cpp/connected_components.cpp > CMakeFiles/example_connected_components.dir/connected_components.cpp.i
...
samples/cpp/CMakeFiles/example_connected_components.dir/connected_components.cpp.s: cmake_force
	...
	cd /home/pi/opencv-3.4.0/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/pi/opencv-3.4.0/samples/cpp/connected_components.cpp -o CMakeFiles/example_connected_components.dir/connected_components.cpp.s
...
bin/cpp-example-connected_components: lib/libopencv_dnn.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_ml.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_objdetect.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_shape.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_stitching.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_superres.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_videostab.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_photo.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_calib3d.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_features2d.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_flann.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_highgui.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_videoio.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_imgcodecs.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_video.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_imgproc.so.3.4.0
bin/cpp-example-connected_components: lib/libopencv_core.so.3.4.0
bin/cpp-example-connected_components: samples/cpp/CMakeFiles/example_connected_components.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/pi/opencv-3.4.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/cpp-example-connected_components"
	cd /home/pi/opencv-3.4.0/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_connected_components.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_connected_components.dir/clean:
	cd /home/pi/opencv-3.4.0/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_connected_components.dir/cmake_clean.cmake
...
samples/cpp/CMakeFiles/example_connected_components.dir/depend:
	cd /home/pi/opencv-3.4.0/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/pi/opencv-3.4.0 /home/pi/opencv-3.4.0/samples/cpp /home/pi/opencv-3.4.0/build /home/pi/opencv-3.4.0/build/samples/cpp /home/pi/opencv-3.4.0/build/samples/cpp/CMakeFiles/example_connected_components.dir/DependInfo.cmake --color=$(COLOR)
