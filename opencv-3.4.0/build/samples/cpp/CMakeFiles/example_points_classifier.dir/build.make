...
samples/cpp/CMakeFiles/example_points_classifier.dir/points_classifier.cpp.o: ../samples/cpp/points_classifier.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/pi/opencv-3.4.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object samples/cpp/CMakeFiles/example_points_classifier.dir/points_classifier.cpp.o"
	cd /home/pi/opencv-3.4.0/build/samples/cpp && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_points_classifier.dir/points_classifier.cpp.o -c /home/pi/opencv-3.4.0/samples/cpp/points_classifier.cpp
...
samples/cpp/CMakeFiles/example_points_classifier.dir/points_classifier.cpp.i: cmake_force
	...
	cd /home/pi/opencv-3.4.0/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/pi/opencv-3.4.0/samples/cpp/points_classifier.cpp > CMakeFiles/example_points_classifier.dir/points_classifier.cpp.i
...
samples/cpp/CMakeFiles/example_points_classifier.dir/points_classifier.cpp.s: cmake_force
	...
	cd /home/pi/opencv-3.4.0/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/pi/opencv-3.4.0/samples/cpp/points_classifier.cpp -o CMakeFiles/example_points_classifier.dir/points_classifier.cpp.s
...
bin/cpp-example-points_classifier: lib/libopencv_dnn.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_ml.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_objdetect.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_shape.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_stitching.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_superres.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_videostab.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_photo.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_calib3d.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_features2d.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_flann.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_highgui.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_videoio.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_imgcodecs.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_video.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_imgproc.so.3.4.0
bin/cpp-example-points_classifier: lib/libopencv_core.so.3.4.0
bin/cpp-example-points_classifier: samples/cpp/CMakeFiles/example_points_classifier.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/pi/opencv-3.4.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/cpp-example-points_classifier"
	cd /home/pi/opencv-3.4.0/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_points_classifier.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_points_classifier.dir/clean:
	cd /home/pi/opencv-3.4.0/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_points_classifier.dir/cmake_clean.cmake
...
samples/cpp/CMakeFiles/example_points_classifier.dir/depend:
	cd /home/pi/opencv-3.4.0/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/pi/opencv-3.4.0 /home/pi/opencv-3.4.0/samples/cpp /home/pi/opencv-3.4.0/build /home/pi/opencv-3.4.0/build/samples/cpp /home/pi/opencv-3.4.0/build/samples/cpp/CMakeFiles/example_points_classifier.dir/DependInfo.cmake --color=$(COLOR)
